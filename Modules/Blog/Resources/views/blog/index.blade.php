...
<div class="col-sm-12 list-container" id="blog-list-container">
    <div class="card">
        ...
        <div class="card-body px-4 blog-table need-batch-operation" data-namespace="\Modules\Blog\Http\Models\Blog"
            data-column="id">
