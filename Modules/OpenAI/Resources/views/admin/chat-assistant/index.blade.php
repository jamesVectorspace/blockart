        ...
        <div class="card-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="d-md-flex mt-2 mt-md-0 justify-content-end align-items-center">
                ...
                @if (in_array('Modules\OpenAI\Http\Controllers\Admin\ChatAssistantsController@create', $prms))
                    <a href="{{ route('admin.chat.assistant.create') }}" class="btn btn-outline-primary mb-0 custom-btn-small">
                        <span class="fa fa-plus pe-2"></span>{{ __('Add :x', ['x' => __('Chat Assistant')]) }}
                    </a>
                @endif
